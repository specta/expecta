...
- (void)test_toBeGreaterThanOrEqualTo {
    ...
    assertFail(test_expect(2).toBeGreaterThanOrEqualTo(3), @"foo.m:123 expected: 2 to be greater than or equal to 3");
    assertFail(test_expect(3.2).toBeGreaterThanOrEqualTo(3.5), @"foo.m:123 expected: 3.2 to be greater than or equal to 3.5");
    assertFail(test_expect([NSNumber numberWithInt:3]).toBeGreaterThanOrEqualTo([NSNumber numberWithInt:4]), @"foo.m:123 expected: 3 to be greater than or equal to 4");
}
...
- (void)test_Not_toBeGreaterThanOrEqualTo {
    ...
    assertFail(test_expect(3).Not.toBeGreaterThanOrEqualTo(2), @"foo.m:123 expected: 3 not to be greater than or equal to 2");
    assertFail(test_expect(3.2).Not.toBeGreaterThanOrEqualTo(3.14), @"foo.m:123 expected: 3.2 not to be greater than or equal to 3.14");
    assertFail(test_expect([NSNumber numberWithInt:3]).Not.toBeGreaterThanOrEqualTo([NSNumber numberWithInt:3]), @"foo.m:123 expected: 3 not to be greater than or equal to 3");
}
