...
- (void)test_toBeLessThanOrEqualTo {
    ...
    assertFail(test_expect(3).toBeLessThanOrEqualTo(2), @"expected: 3 to be less than or equal to 2");
    assertFail(test_expect(3.8).toBeLessThanOrEqualTo(3.2), @"expected: 3.8 to be less than or equal to 3.2");
    assertFail(test_expect([NSNumber numberWithInt:3]).toBeLessThanOrEqualTo([NSNumber numberWithInt:2]), @"expected: 3 to be less than or equal to 2");
}
...
- (void)test_Not_toBeLessThanOrEqualTo {
    ...
    assertFail(test_expect(2).Not.toBeLessThanOrEqualTo(3), @"expected: 2 not to be less than or equal to 3");
    assertFail(test_expect(3.2).Not.toBeLessThanOrEqualTo(3.8), @"expected: 3.2 not to be less than or equal to 3.8");
    assertFail(test_expect([NSNumber numberWithInt:2]).Not.toBeLessThanOrEqualTo([NSNumber numberWithInt:3]), @"expected: 2 not to be less than or equal to 3");
}
