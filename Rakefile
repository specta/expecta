...
task :build => :clean do |t|
  ...
  tvos_sim_static_lib = build_static_lib('libExpecta-tvOS', 'appletvsimulator')
  tvos_static_lib     = build_static_lib('libExpecta-tvOS', 'appletvos')
  ...
  tvos_univ_static_lib = generate_universal_static_library("tvOS", tvos_univ_build_path, tvos_sim_static_lib, tvos_static_lib)
  ...
  execute "cp -a #{tvos_univ_static_lib} Products/tvos"
